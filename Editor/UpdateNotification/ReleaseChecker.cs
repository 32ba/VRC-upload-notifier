...
namespace Net._32ba.VrchatUploadNotifier.UpdateNotification
{
    [InitializeOnLoad]
    internal static class ReleaseChecker
    {
        private const string PackageId = "net.32ba.vrchat-upload-notifier";
        private const string PackageDisplayName = "VRChat Upload Notifier";
        private const string ReleasePageUrl = "https://github.com/32ba/VRC-upload-notifier/releases";
        private const string LastCheckKeyPrefix = "net.32ba.vrchat.upload.notifier.LastVersionCheck";
